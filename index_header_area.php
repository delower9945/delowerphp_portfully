        ...
        <header>
                        ...
                        <div class="col-xl-12">
                            <div class="main-menu">
                                <nav class="navbar navbar-expand-lg">
                                    <a href="index.php" class="navbar-brand logo-sticky-none"><img src="frontend_asset/img/logo/logod.png" alt="Logo"></a>
                                    <a href="index.php" class="navbar-brand s-logo-none"><img src="frontend_asset/img/logo/logod.png" alt="Logo"></a>
            ...
            <div class="extra-info">
                ...
                <div class="logo-side mb-30">
                    <a href="index-2.html">
                        <img src="frontend_asset/img/logo/logo.png" alt="" />
                    </a>
                </div>
