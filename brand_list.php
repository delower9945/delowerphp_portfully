<?php
	...
	$select_quriy="SELECT * FROM brand";
				...
				<div class="col-md-12 m-auto">
					...
					<table class="table table-bordered" id="add_user_tbal">
					 ...
					 <tbody>
					  	...
					  	<?php 
					  		$sl_nam = 1;
					  		foreach ($add_list_from as $brand): ?>
					    <tr>
					      <td><?=$sl_nam++?></td>
					   
					      <td ><img style="height: 100px; border-radius: 50%" src="uploads/protfulios/<?=$brand['logo']?>" alt=""></td>
					      <td>
					      	...
					      	<div class="btn-group" role="group" aria-label="Basic example">
								  ...
								  <a href="brand_delet.php?logo=<?=$brand['id']?>" type="button" id="numbe"class="text-white btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i>
								  Delet</a>
							</div>
